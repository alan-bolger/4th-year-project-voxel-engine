    ...
    const uint32_t& depth = 0)
{
    ...
    if (trace(orig, dir, objects, isect)) {
        ...
        case kDiffuse:
        {
            ...
            hitColor = (directLighting) * isect.hitObject->albedo;
            break;
        }
        default:
            break;
...
//
//    TriangleMesh* plane = loadPolyMeshFromFile("models/planegi.geo", Matrix44f::kIdentity);
//    if (plane != nullptr) {
//        plane->albedo = Vec3f(0.225, 0.144, 0.144);
//        objects.push_back(std::unique_ptr<Object>(plane));
//    }
//
//    TriangleMesh* cube = loadPolyMeshFromFile("models/cubegi.geo", Matrix44f::kIdentity);
//    if (cube != nullptr) {
