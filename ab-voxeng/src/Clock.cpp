...
/// Get elapsed time.
/// </summary>
/// <returns>The time elapsed since the last call to restart().</returns>
...
/// Get total time.
/// </summary>
/// <returns>The time since the Clock object was created.</returns>
...
/// </summary>
/// <returns>The time elapsed since the clock was restarted (or created if restart() hasn't been called yet).</returns>
